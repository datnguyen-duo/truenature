            ...
            <div class="third_section_content fadein_wrap">
                ...
                <div class="right">
                    <div class="right_content">
                        ...
                        <ul>
                            <li>
                            Established in 2013, True Nature offers private therapy, small group classes, and mentoring in the Viniyoga tradition.
                            </li>
                            <li>
                            Previously a gallery space, the studio still hosts occasional workshops and special events.
                            </li>
                            <li>
                            The studio is located in the town of Rio Vista, in the California Delta, just a little up river of The San Francisco Bay.
                            </li>
                            <li>
                            The studio is open and we are meeting with individual clients both in-person and remotely. Groups are meeting remotely, via Zoom.
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="fifth_section_content fadein_wrap">
                ...
                <div class="right">
                    <div class="right_content">
                        <h2>//About Briana</h2>
                        <h3>
                            True Nature small group classes and private sessions are led by Briana Soladay.
                        </h3>

                        <p>
                            Practicing as a Yoga Therapist, certified by the International Association of Yoga Therapists, Briana also holds a Masters in Counseling Psychology (MFT & LPCC) and is a Registered Associate Marriage and Family Therapist. A link in the chain of the authentic transmission of yoga, Briana practices and teaches in the lineage of T. Krishnamacharya and T.K.V. Desikachar, known as Viniyoga. A personal student of Chase Bossart, Briana has also studied in the lineage with Dolphi Wertenbaker, Amy Wheeler, Gary Kraftsow, Dawn Summers, and Leslie Kaminoff.
                        </p>
                    </div>
                </div>
            </div>
